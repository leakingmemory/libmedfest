...
FestDeserializer_1::FestDeserializer_1(const std::shared_ptr<FestDeserializerMapping> &raw) : raw(raw) {
    ...
    }
    {
        ...
        if ((trailer->secondHeaderOffset + sizeof(FestSecondHeader)) > (raw->mapsize - 1)) {
    ...
    if (secondHeader != nullptr) {
        ...
        if (versionMajor > 1 || (versionMajor == 1 && versionMinor > 0)) {
            ...
            if (versionMajor > 1 || (versionMajor == 1 && versionMinor > 1)) {
                refRefusjonsvilkarList_1_2_0 = (const PRefRefusjonsvilkar_1_2_0 *) (void *) (((uint8_t *) raw->mapping) + offset);
                ...
                refusjonskodeList_1_2_0 = (const PRefusjonskode_1_2_0 *) (void *) (((uint8_t *) raw->mapping) + offset);
                ...
                if (versionMajor > 1 || (versionMajor == 1 && versionMinor > 2)) {
                    fests_V_1_3_0 = (const PFest_V_1_3_0 *) (void *) (((uint8_t *) raw->mapping) + offset);
                    ...
                    pakning_1_3_0 = (const POppfLegemiddelpakning_1_3_0 *) (void *) (((uint8_t *) raw->mapping) + offset);
                ...
                if (versionMajor > 1 || (versionMajor == 1 && versionMinor > 3)) {
                    refusjon_1_4_0 = (const POppfRefusjon_1_4_0 *) (void *) (((uint8_t *) raw->mapping) + offset);
                    ...
                    refusjonsgruppeList = (const PRefusjonsgruppe *) (void *) (((uint8_t *) raw->mapping) + offset);
                    ...
                    if (versionMajor > 1 || (versionMajor == 1 && versionMinor > 4)) {
                        byttegruppe_1_5_0 = (const POppfByttegruppe_1_5_0 *) (void *) (((uint8_t *) raw->mapping) + offset);
...
FestDeserializer_1::~FestDeserializer_1() = default;

int FestDeserializer_1::GetVersionMajor() const {
    return versionMajor;
}

int FestDeserializer_1::GetVersionMinor() const {
    return versionMinor;
}

int FestDeserializer_1::GetVersionPatch() const {
    return versionPatch;
}

std::vector<POppfLegemiddelMerkevare_0_0_0> FestDeserializer_1::GetLegemiddelMerkevare_0_0_0() const {
...
std::vector<POppfLegemiddelMerkevare_0_4_0> FestDeserializer_1::GetLegemiddelMerkevare_0_4_0() const {
...
std::vector<POppfLegemiddelMerkevare> FestDeserializer_1::GetLegemiddelMerkevare() const {
...
std::vector<POppfLegemiddelpakning_0_0_0> FestDeserializer_1::GetLegemiddelPakning_0_0_0() const {
...
std::vector<POppfLegemiddelpakning_0_4_0> FestDeserializer_1::GetLegemiddelPakning_0_4_0() const {
...
std::vector<POppfLegemiddelpakning_1_3_0> FestDeserializer_1::GetLegemiddelPakning_1_3_0() const {
...
std::vector<POppfLegemiddelpakning> FestDeserializer_1::GetLegemiddelPakning() const {
...
std::vector<POppfLegemiddelVirkestoff_0_0_0> FestDeserializer_1::GetLegemiddelVirkestoff_0_0_0() const {
...
std::vector<POppfLegemiddelVirkestoff_0_4_0> FestDeserializer_1::GetLegemiddelVirkestoff_0_4_0() const {
...
std::vector<POppfLegemiddelVirkestoff> FestDeserializer_1::GetLegemiddelVirkestoff() const {
...
std::vector<POppfMedForbrMatr> FestDeserializer_1::GetMedForbrMatr() const {
...
std::vector<POppfNaringsmiddel> FestDeserializer_1::GetNaringsmiddel() const {
...
std::vector<POppfBrystprotese> FestDeserializer_1::GetBrystprotese() const {
...
std::vector<POppfLegemiddeldose_0_0_0> FestDeserializer_1::GetLegemiddeldose_0_0_0() const {
...
std::vector<POppfLegemiddeldose_0_4_0> FestDeserializer_1::GetLegemiddeldose_0_4_0() const {
...
std::vector<POppfLegemiddeldose> FestDeserializer_1::GetLegemiddeldose() const {
...
std::vector<POppfVirkestoffMedStyrke> FestDeserializer_1::GetVirkestoffMedStyrke() const {
...
std::vector<POppfVirkestoff_0_0_0> FestDeserializer_1::GetVirkestoff_0_0_0() const {
...
std::vector<POppfVirkestoff_0_4_0> FestDeserializer_1::GetVirkestoff_0_4_0() const {
...
std::vector<POppfVirkestoff> FestDeserializer_1::GetVirkestoff() const {
...
std::vector<POppfRefusjon_0_0_0> FestDeserializer_1::GetOppfRefusjon_0_0_0() const {
...
std::vector<POppfRefusjon_1_4_0> FestDeserializer_1::GetOppfRefusjon_1_4_0() const {
...
std::vector<POppfRefusjon> FestDeserializer_1::GetOppfRefusjon() const {
...
std::vector<POppfVilkar> FestDeserializer_1::GetOppfVilkar() const {
...
std::vector<POppfVarselSlv_0_4_0> FestDeserializer_1::GetVarselSlv_0_4_0() const {
...
std::vector<POppfVarselSlv_0_0_0> FestDeserializer_1::GetVarselSlv_0_0_0() const {
...
std::vector<POppfVarselSlv> FestDeserializer_1::GetVarselSlv() const {
...
std::vector<POppfKodeverk_0_3_0> FestDeserializer_1::GetOppfKodeverk_0_3_0() const {
...
std::vector<POppfByttegruppe_0_0_0> FestDeserializer_1::GetByttegruppe_0_0_0() const {
...
std::vector<POppfByttegruppe_1_5_0> FestDeserializer_1::GetByttegruppe_1_5_0() const {
...
std::vector<POppfInteraksjon> FestDeserializer_1::GetInteraksjon() const {
...
std::vector<POppfInteraksjonIkkeVurdert> FestDeserializer_1::GetInteraksjonIkkeVurdert() const {
...
std::vector<POppfStrDosering> FestDeserializer_1::GetStrDosering() const {
...
std::vector<PString> FestDeserializer_1::GetStrings() const {
...
std::vector<PPrisVare> FestDeserializer_1::GetPrisVare() const {
...
std::vector<PPakningsinfo> FestDeserializer_1::GetPakningsinfo() const {
...
std::vector<PPakningskomponent> FestDeserializer_1::GetPakningskomponent() const {
...
std::vector<PPakningskomponentInfo> FestDeserializer_1::GetPakningskomponentInfo() const {
...
std::vector<PReseptgyldighet> FestDeserializer_1::GetReseptgyldighet() const {
...
std::vector<PValueWithCodeset> FestDeserializer_1::GetValueWithCodeset() const {
...
std::vector<FestUuid> FestDeserializer_1::GetFestIds() const {
...
std::vector<PFestId> FestDeserializer_1::GetFestIdLists_0_0_0() const {
...
std::vector<PFestId> FestDeserializer_1::GetFestIdLists_0_4_0() const {
    std::vector<PFestId> festIds{};
...
std::vector<PFestId> FestDeserializer_1::GetFestIdLists() const {
    if (versionMajor > 1 || (versionMajor == 1 && versionMinor > 0) || (versionMajor == 0 && versionMinor > 3)) {
...
std::vector<PRefusjon> FestDeserializer_1::GetRefusjon() const {
...
std::vector<PElement_0_3_0> FestDeserializer_1::GetElement_0_3_0() const {
...
std::vector<PElement> FestDeserializer_1::GetElement() const {
...
std::vector<PRefRefusjonsvilkar_0_0_0> FestDeserializer_1::GetRefRefusjonsvilkar_0_0_0() const {
...
std::vector<PRefRefusjonsvilkar_1_2_0> FestDeserializer_1::GetRefRefusjonsvilkar_1_2_0() const {
...
std::vector<PRefRefusjonsvilkar> FestDeserializer_1::GetRefRefusjonsvilkar() const {
...
std::vector<PRefusjonskode_0_1_0> FestDeserializer_1::GetRefusjonskode_0_1_0() const {
...
std::vector<PRefusjonskode_1_2_0> FestDeserializer_1::GetRefusjonskode_1_2_0() const {
...
std::vector<PRefusjonskode> FestDeserializer_1::GetRefusjonskode() const {
...
std::vector<PReferanse> FestDeserializer_1::GetReferanse() const {
...
std::vector<PSubstansgruppe> FestDeserializer_1::GetSubstansgruppe() const {
...
std::vector<PSubstans> FestDeserializer_1::GetSubstans() const {
...
std::vector<PDoseFastTidspunkt> FestDeserializer_1::GetDoseFastTidspunkt() const {
...
std::vector<PDosering> FestDeserializer_1::GetDosering() const {
...
std::vector<PLegemiddelforbruk> FestDeserializer_1::GetLegemiddelforbruk() const {
...
std::vector<PString> FestDeserializer_1::GetStringList() const {
    std::vector<PString> strings{};
...
void FestDeserializer_1::ForEachMerkevare_0_0_0(const std::function<void(const POppfLegemiddelMerkevare_0_0_0 &)> &func) const {
    for (std::remove_const<decltype(numMerkevare_0_0_0)>::type i = 0; i < numMerkevare_0_0_0; i++) {
        func(this->merkevare_0_0_0[i]);
    }
}

void FestDeserializer_1::ForEachMerkevare_0_4_0(const std::function<void(const POppfLegemiddelMerkevare_0_4_0 &)> &func) const {
    for (std::remove_const<decltype(numMerkevare_0_4_0)>::type i = 0; i < numMerkevare_0_4_0; i++) {
        func(this->merkevare_0_4_0[i]);
    }
}

void FestDeserializer_1::ForEachMerkevare(const std::function<void(const POppfLegemiddelMerkevare &)> &func) const {
    if (versionMajor > 1 || (versionMajor == 1 && versionMinor > 0) || (versionMajor == 0 && versionMinor > 3)) {
...
void FestDeserializer_1::ForEachPakning_0_0_0(const std::function<void(const POppfLegemiddelpakning_0_0_0 &)> &func) const {
    for (std::remove_const<decltype(numPakning_0_0_0)>::type i = 0; i < numPakning_0_0_0; i++) {
        func(this->pakning_0_0_0[i]);
    }
}

void FestDeserializer_1::ForEachPakning_0_4_0(const std::function<void(const POppfLegemiddelpakning_0_4_0 &)> &func) const {
    for (std::remove_const<decltype(numPakning_0_4_0)>::type i = 0; i < numPakning_0_4_0; i++) {
        func(this->pakning_0_4_0[i]);
    }
}

void FestDeserializer_1::ForEachPakning_1_3_0(const std::function<void(const POppfLegemiddelpakning_1_3_0 &)> &func) const {
    for (std::remove_const<decltype(numPakning_1_3_0)>::type i = 0; i < numPakning_1_3_0; i++) {
        func(this->pakning_1_3_0[i]);
    }
}

void FestDeserializer_1::ForEachPakning(const std::function<void(const POppfLegemiddelpakning &)> &func) const {
    if (versionMajor > 1 || (versionMajor == 1 && versionMinor > 2)) {
...
void FestDeserializer_1::ForEachLegemiddelVirkestoff_0_0_0(const std::function<void(const POppfLegemiddelVirkestoff_0_0_0 &)> &func) const {
...
void FestDeserializer_1::ForEachLegemiddelVirkestoff_0_4_0(const std::function<void(const POppfLegemiddelVirkestoff_0_4_0 &)> &func) const {
...
void FestDeserializer_1::ForEachLegemiddelVirkestoff(const std::function<void(const POppfLegemiddelVirkestoff &)> &func) const {
    if (versionMajor > 1 || (versionMajor == 1 && versionMinor > 0) || (versionMajor == 0 && versionMinor > 3)) {
...
void FestDeserializer_1::ForEachMedForbrMatr(const std::function<void(const POppfMedForbrMatr &)> &func) const {
    for (std::remove_const<decltype(numMedForbrMatr)>::type i = 0; i < numMedForbrMatr; i++) {
        func(this->medForbrMatr[i]);
    }
}

void FestDeserializer_1::ForEachNaringsmiddel(const std::function<void(const POppfNaringsmiddel &)> &func) const {
    for (std::remove_const<decltype(numNaringsmiddel)>::type i = 0; i < numNaringsmiddel; i++) {
        func(this->naringsmiddel[i]);
    }
}

void FestDeserializer_1::ForEachBrystprotese(const std::function<void(const POppfBrystprotese &)> &func) const {
    for (std::remove_const<decltype(numBrystprotese)>::type i = 0; i < numBrystprotese; i++) {
        func(this->brystprotese[i]);
    }
}

void FestDeserializer_1::ForEachLegemiddeldose_0_0_0(const std::function<void(const POppfLegemiddeldose_0_0_0 &)> &func) const {
...
void FestDeserializer_1::ForEachLegemiddeldose_0_4_0(const std::function<void(const POppfLegemiddeldose_0_4_0 &)> &func) const {
...
void FestDeserializer_1::ForEachLegemiddeldose(const std::function<void(const POppfLegemiddeldose &)> &func) const {
    if (versionMajor > 1 || (versionMajor == 1 && versionMinor > 0) || (versionMajor == 0 && versionMinor > 3)) {
...
void FestDeserializer_1::ForEachVirkestoffMedStyrke(const std::function<void(const POppfVirkestoffMedStyrke &)> &func) const {
    for (std::remove_const<decltype(numVirkestoffMedStyrke)>::type i = 0; i < numVirkestoffMedStyrke; i++) {
        func(this->virkestoffMedStyrke[i]);
    }
}

void FestDeserializer_1::ForEachVirkestoff_0_0_0(const std::function<void(const POppfVirkestoff_0_0_0 &)> &func) const {
    for (std::remove_const<decltype(numVirkestoff_0_0_0)>::type i = 0; i < numVirkestoff_0_0_0; i++) {
        func(this->virkestoff_0_0_0[i]);
    }
}

void FestDeserializer_1::ForEachVirkestoff_0_4_0(const std::function<void(const POppfVirkestoff_0_4_0 &)> &func) const {
    for (std::remove_const<decltype(numVirkestoff_0_4_0)>::type i = 0; i < numVirkestoff_0_4_0; i++) {
        func(this->virkestoff_0_4_0[i]);
    }
}

void FestDeserializer_1::ForEachVirkestoff(const std::function<void(const POppfVirkestoff &)> &func) const {
    if (versionMajor > 1 || (versionMajor == 1 && versionMinor > 0) || (versionMajor == 0 && versionMinor > 3)) {
...
void FestDeserializer_1::ForEachKodeverk_0_3_0(const std::function<void(const POppfKodeverk_0_3_0 &)> &func) const {
    for (std::remove_const<decltype(numKodeverk_0_3_0)>::type i = 0; i < numKodeverk_0_3_0; i++) {
        func(this->kodeverk_0_3_0[i]);
    }
}

void FestDeserializer_1::ForEachKodeverk(const std::function<void(const POppfKodeverk &)> &func) const {
...
void FestDeserializer_1::ForEachRefusjon_0_0_0(const std::function<void(const POppfRefusjon_0_0_0 &)> &func) const {
    for (std::remove_const<decltype(numRefusjon_0_0_0)>::type i = 0; i < numRefusjon_0_0_0; i++) {
        func(this->refusjon_0_0_0[i]);
    }
}

void FestDeserializer_1::ForEachRefusjon_1_4_0(const std::function<void(const POppfRefusjon_1_4_0 &)> &func) const {
    for (std::remove_const<decltype(numRefusjon_1_4_0)>::type i = 0; i < numRefusjon_1_4_0; i++) {
        func(this->refusjon_1_4_0[i]);
    }
}

void FestDeserializer_1::ForEachRefusjon(const std::function<void(const POppfRefusjon &)> &func) const {
    if (versionMajor > 1 || (versionMajor == 1 && versionMinor > 3)) {
...
void FestDeserializer_1::ForEachVilkar(const std::function<void(const POppfVilkar &)> &func) const {
    for (std::remove_const<decltype(numVilkar)>::type i = 0; i < numVilkar; i++) {
        func(this->vilkar[i]);
    }
}

void FestDeserializer_1::ForEachVarselSlv_0_0_0(const std::function<void(const POppfVarselSlv_0_0_0 &)> &func) const {
    for (std::remove_const<decltype(numVarselSlv_0_0_0)>::type i = 0; i < numVarselSlv_0_0_0; i++) {
        func(this->varselSlv_0_0_0[i]);
    }
}

void FestDeserializer_1::ForEachVarselSlv_0_4_0(const std::function<void(const POppfVarselSlv_0_4_0 &)> &func) const {
    for (std::remove_const<decltype(numVarselSlv_0_4_0)>::type i = 0; i < numVarselSlv_0_4_0; i++) {
        func(this->varselSlv_0_4_0[i]);
    }
}

void FestDeserializer_1::ForEachVarselSlv(const std::function<void(const POppfVarselSlv &)> &func) const {
    if (versionMajor > 1 || (versionMajor == 1 && versionMinor > 0) || (versionMajor == 0 && versionMinor > 3)) {
...
void FestDeserializer_1::ForEachByttegruppe_0_0_0(const std::function<void(const POppfByttegruppe_0_0_0 &)> &func) const {
    for (std::remove_const<decltype(numByttegruppe)>::type i = 0; i < numByttegruppe; i++) {
        func(this->byttegruppe_0_0_0[i]);
    }
}

void FestDeserializer_1::ForEachByttegruppe_1_5_0(const std::function<void(const POppfByttegruppe_1_5_0 &)> &func) const {
    for (std::remove_const<decltype(numByttegruppe)>::type i = 0; i < numByttegruppe; i++) {
        func(this->byttegruppe_1_5_0[i]);
    }
}

void FestDeserializer_1::ForEachByttegruppe(const std::function<void(const POppfByttegruppe &)> &func) const {
...
void FestDeserializer_1::ForEachInteraksjon(const std::function<void(const POppfInteraksjon &)> &func) const {
    for (std::remove_const<decltype(numInteraksjon)>::type i = 0; i < numInteraksjon; i++) {
        func(this->interaksjon[i]);
    }
}

void FestDeserializer_1::ForEachInteraksjonIkkeVurdert(const std::function<void(const POppfInteraksjonIkkeVurdert &)> &func) const {
    for (std::remove_const<decltype(numInteraksjonIkkeVurdert)>::type i = 0; i < numInteraksjonIkkeVurdert; i++) {
        func(this->interaksjonIkkeVurdert[i]);
    }
}

void FestDeserializer_1::ForEachStrDosering(const std::function<void(const POppfStrDosering &)> &func) const {
    for (std::remove_const<decltype(numStrDosering)>::type i = 0; i < numStrDosering; i++) {
        func(this->strDosering[i]);
    }
}

void FestDeserializer_1::ForEachFests_V_0_3_0(const std::function<void(const PFest_V_0_3_0 &)> &func) const {
    for (std::remove_const<decltype(numFests_V_0_3_0)>::type i = 0; i < numFests_V_0_3_0; i++) {
        func(this->fests_V_0_3_0[i]);
    }
}

void FestDeserializer_1::ForEachFests_V_0_4_0(const std::function<void(const PFest_V_0_4_0 &)> &func) const {
    for (std::remove_const<decltype(numFests_V_0_4_0)>::type i = 0; i < numFests_V_0_4_0; i++) {
        func(this->fests_V_0_4_0[i]);
    }
}

void FestDeserializer_1::ForEachFests_V_1_3_0(const std::function<void(const PFest_V_1_3_0 &)> &func) const {
    for (std::remove_const<decltype(numFests_V_1_3_0)>::type i = 0; i < numFests_V_1_3_0; i++) {
        func(this->fests_V_1_3_0[i]);
    }
}

void FestDeserializer_1::ForEachFests(const std::function<void(const PFest &)> &func) const {
    if (GetVersionMajor() > 1 || (GetVersionMajor() == 1 && GetVersionMinor() > 2)) {
        ForEachFests_V_1_3_0([func] (const PFest_V_1_3_0 &festV) {
            PFest fest{festV};
            func(fest);
        });
    } else if (GetVersionMajor() > 0 && GetVersionMinor() > 0) {
...
FestVectors FestDeserializer_1::Unpack(const PFest_V_0_3_0 &pFest) const {
    return {pFest, Unpack(pFest.dato), uint16List, numUint16List, uint32List, numUint32List};
}

FestVectors FestDeserializer_1::Unpack(const PFest_V_0_4_0 &pFest) const {
    return {pFest, Unpack(pFest.dato), uint16List, numUint16List, uint32List, numUint32List};
}

FestVectors FestDeserializer_1::Unpack(const PFest_V_1_3_0 &pFest) const {
    return {pFest, Unpack(pFest.dato), uint16List, numUint16List, uint32List, numUint32List};
}

FestVectors FestDeserializer_1::Unpack(const PFest &fest) const {
...
std::string FestDeserializer_1::Unpack(const PString &str) const {
    return str.ToString(stringblock, stringblocksize);
}

Reseptgyldighet FestDeserializer_1::Unpack(const PReseptgyldighet &reseptgyldighet) const {
    Reseptgyldighet r{Unpack(reseptgyldighet.varighet), Unpack(reseptgyldighet.kjonn)};
    return r;
}

ValueWithDistinguishedName FestDeserializer_1::Unpack(
...
ValueWithCodeSet FestDeserializer_1::Unpack(const PValueWithCodeset &valueWithCodeset) const {
    ValueWithCodeSet v{
...
ValueUnit FestDeserializer_1::Unpack(const PValueUnit &valueUnit) const {
    ValueUnit v{valueUnit.value, Unpack(valueUnit.unit)};
    return v;
}

FestUuid FestDeserializer_1::Unpack(PFestId festId) const {
...
OppfKodeverk FestDeserializer_1::Unpack(const POppfKodeverk &poppf) const {
    struct {
        const FestDeserializer_1 *deserializer;
        OppfKodeverk operator () (const POppfKodeverk_0_3_0 &poppf) {
            return deserializer->Unpack(poppf);
        }
        OppfKodeverk operator () (const POppfKodeverk_0_0_0 &poppf) {
            throw PackException("This version does not use the v0.0.0 struct");
        }
    } visitor{.deserializer = this};
    return std::visit(visitor, poppf);
}

OppfRefusjon FestDeserializer_1::Unpack(const POppfRefusjon_0_0_0 &poppf) const {
    return {Unpack(static_cast<const POppf>(poppf)), Unpack(static_cast<const PRefusjonshjemmel_0_0_0>(poppf))};
}

OppfRefusjon FestDeserializer_1::Unpack(const POppfRefusjon_1_4_0 &poppf) const {
    return {Unpack(static_cast<const POppf>(poppf)), Unpack(static_cast<const PRefusjonshjemmel_1_4_0>(poppf))};
}

OppfRefusjon FestDeserializer_1::Unpack(const POppfRefusjon &poppf) const {
...
OppfVilkar FestDeserializer_1::Unpack(const POppfVilkar &poppf) const {
    return {Unpack(static_cast<const POppf>(poppf)), Unpack(static_cast<const PVilkar>(poppf))};
}

OppfVarselSlv FestDeserializer_1::Unpack(const POppfVarselSlv_0_0_0 &poppf) const {
    return {Unpack(static_cast<const POppf>(poppf)), Unpack(static_cast<const PVarselSlv_0_0_0>(poppf))};
}

OppfVarselSlv FestDeserializer_1::Unpack(const POppfVarselSlv_0_4_0 &poppf) const {
    return {Unpack(static_cast<const POppf>(poppf)), Unpack(static_cast<const PVarselSlv_0_4_0>(poppf))};
}

OppfVarselSlv FestDeserializer_1::Unpack(const POppfVarselSlv &poppf) const {
...
OppfByttegruppe FestDeserializer_1::Unpack(const POppfByttegruppe_0_0_0 &poppf) const {
    return {Unpack(static_cast<const POppf>(poppf)), Unpack(static_cast<const PByttegruppe_0_0_0>(poppf))};
}

OppfByttegruppe FestDeserializer_1::Unpack(const POppfByttegruppe_1_5_0 &poppf) const {
    return {Unpack(static_cast<const POppf>(poppf)), Unpack(static_cast<const PByttegruppe_1_5_0>(poppf))};
}

OppfByttegruppe FestDeserializer_1::Unpack(const POppfByttegruppe &poppf) const {
    struct {
        const FestDeserializer_1 *festDeserializer;
...
OppfInteraksjon FestDeserializer_1::Unpack(const POppfInteraksjon &poppf) const {
    return {Unpack(static_cast<const POppf>(poppf)), Unpack(static_cast<const PInteraksjon>(poppf))};
}

OppfInteraksjonIkkeVurdert FestDeserializer_1::Unpack(const POppfInteraksjonIkkeVurdert &poppf) const {
    return {Unpack(static_cast<const POppf>(poppf)), Unpack(static_cast<const PInteraksjonIkkeVurdert>(poppf))};
}

OppfStrDosering FestDeserializer_1::Unpack(const POppfStrDosering &poppf) const {
    return {Unpack(static_cast<const POppf>(poppf)), Unpack(static_cast<PKortdose>(poppf))};
}

Oppf FestDeserializer_1::Unpack(const POppf &poppf) const {
    Status status{Unpack(poppf.status)};
    return {Unpack(poppf.id).ToString(), Unpack(poppf.tidspunkt), status};
}

LegemiddelMerkevare FestDeserializer_1::Unpack(const PLegemiddelMerkevare_0_0_0 &pmerkevare) const {
...
LegemiddelMerkevare FestDeserializer_1::Unpack(const PLegemiddelMerkevare_0_4_0 &pmerkevare) const {
    std::vector<Reseptgyldighet> reseptgyldighet{};
    {
        auto rg = Unpack(reseptgyldighetList, numReseptgyldighet, pmerkevare.reseptgyldighet);
        for (const auto &r : rg) {
...
LegemiddelMerkevare FestDeserializer_1::Unpack(const PLegemiddelMerkevare &pmerkevare) const {
...
Legemiddelpakning FestDeserializer_1::Unpack(const PLegemiddelpakning_0_0_0 &ppakning) const {
...
Legemiddelpakning FestDeserializer_1::Unpack(const PLegemiddelpakning_0_4_0 &ppakning) const {
    std::vector<Pakningsinfo> pakningsinfo{};
    {
        auto list = Unpack(pakningsinfoList, numPakningsinfo, ppakning.pakningsinfo);
        for (const auto &ppi : list) {
...
Legemiddelpakning FestDeserializer_1::Unpack(const PLegemiddelpakning_1_3_0 &ppakning) const {
    std::vector<Pakningsinfo> pakningsinfo{};
    {
        auto list = Unpack(pakningsinfoList, numPakningsinfo, ppakning.pakningsinfo);
        for (const auto &ppi : list) {
...
Legemiddelpakning FestDeserializer_1::Unpack(const PLegemiddelpakning &pl) const {
...
LegemiddelVirkestoff FestDeserializer_1::Unpack(const PLegemiddelVirkestoff_0_0_0 &pvirkestoff) const {
    std::vector<Refusjon> refusjon{};
    {
...
LegemiddelVirkestoff FestDeserializer_1::Unpack(const PLegemiddelVirkestoff_0_4_0 &pvirkestoff) const {
    std::vector<Refusjon> refusjon{};
    {
        auto list = Unpack(this->refusjonList, numRefusjonList, pvirkestoff.refusjon);
        for (const auto &item : list) {
...
LegemiddelVirkestoff FestDeserializer_1::Unpack(const PLegemiddelVirkestoff &pvirkestoff) const {
...
Handelsvare FestDeserializer_1::Unpack(const PHandelsvare &pHandelsvare) const {
    std::vector<PrisVare> prisVare{};
    {
...
Legemiddeldose FestDeserializer_1::Unpack(const PLegemiddeldose_0_0_0 &pLegemiddeldose) const {
    std::vector<std::string> refLegemiddelMerkevare{};
    {
...
Legemiddeldose FestDeserializer_1::Unpack(const PLegemiddeldose_0_4_0 &pLegemiddeldose) const {
    std::vector<std::string> refLegemiddelMerkevare{};
    {
...
Legemiddeldose FestDeserializer_1::Unpack(const PLegemiddeldose &pLegemiddeldose) const {
...
VirkestoffMedStyrke FestDeserializer_1::Unpack(const PVirkestoffMedStyrke &pVirkestoffMedStyrke) const {
    return {
...
Virkestoff FestDeserializer_1::Unpack(const PVirkestoff_0_0_0 &pVirkestoff) const {
...
Virkestoff FestDeserializer_1::Unpack(const PVirkestoff_0_4_0 &pVirkestoff) const {
    std::vector<std::string> refVirkestoff{};
    {
...
Virkestoff FestDeserializer_1::Unpack(const PVirkestoff &pVirkestoff) const {
...
Info FestDeserializer_1::Unpack(const PInfo &pInfo) const {
    return {
        Unpack(pInfo.id),
...
Refusjonshjemmel FestDeserializer_1::Unpack(const PRefusjonshjemmel_0_0_0 &pRefusjonshjemmel) const {
    return {
...
Refusjonshjemmel FestDeserializer_1::Unpack(const PRefusjonshjemmel_1_4_0 &pRefusjonshjemmel) const {
...
Refusjonshjemmel FestDeserializer_1::Unpack(const PRefusjonshjemmel &pRefusjonshjemmel) const {
...
Vilkar FestDeserializer_1::Unpack(const PVilkar &pVilkar) const {
    return {
        Unpack(pVilkar.id),
...
VarselSlv FestDeserializer_1::Unpack(const PVarselSlv_0_0_0 &pVarselSlv) const {
...
VarselSlv FestDeserializer_1::Unpack(const PVarselSlv_0_4_0 &pVarselSlv) const {
    std::vector<Visningsregel> visningsregel{};
    {
        auto list = Unpack(valueWithCodesetList, numValueWithCodesetList, pVarselSlv.visningsregel);
        for (const auto &item : list) {
...
VarselSlv FestDeserializer_1::Unpack(const PVarselSlv &pVarselSlv) const {
...
Byttegruppe FestDeserializer_1::Unpack(const PByttegruppe_0_0_0 &pByttegruppe) const {
    return {
...
Byttegruppe FestDeserializer_1::Unpack(const PByttegruppe_1_5_0 &pByttegruppe) const {
    return {
        Unpack(pByttegruppe.id).ToString(),
        Unpack(pByttegruppe.kode),
        Unpack(pByttegruppe.gyldigFraDato),
...
Byttegruppe FestDeserializer_1::Unpack(const PByttegruppe &pByttegruppe) const {
    return std::visit(
...
Interaksjon FestDeserializer_1::Unpack(const PInteraksjon &pInteraksjon) const {
    std::vector<Visningsregel> visningsregel{};
    {
...
InteraksjonIkkeVurdert FestDeserializer_1::Unpack(const PInteraksjonIkkeVurdert &pInteraksjonIkkeVurdert) const {
    return {Unpack(pInteraksjonIkkeVurdert.atc)};
}

Kortdose FestDeserializer_1::Unpack(const PKortdose &pKortdose) const {
...
Legemiddel FestDeserializer_1::Unpack(const PLegemiddel_0_0_0 &pLegemiddel) const {
...
Legemiddel FestDeserializer_1::Unpack(const PLegemiddel_0_4_0 &pLegemiddel) const {
    std::vector<std::string> sortertVirkestoffMedStyrke{};
    {
...
Legemiddel FestDeserializer_1::Unpack(const PLegemiddel &pLegemiddel) const {
...
LegemiddelCore FestDeserializer_1::Unpack(const PLegemiddelCore_0_0_0 &pLegemiddelCore) const {
...
LegemiddelCore FestDeserializer_1::Unpack(const PLegemiddelCore_0_4_0 &pLegemiddelCore) const {
    std::vector<std::string> refVilkar{};
    {
...
LegemiddelCore FestDeserializer_1::Unpack(const PLegemiddelCore &pLegemiddelCore) const {
...
AdministreringLegemiddel FestDeserializer_1::Unpack(const PAdministreringLegemiddel &pAdministreringLegemiddel) const {
...
Preparatomtaleavsnitt FestDeserializer_1::Unpack(const PPreparatomtaleavsnitt &pPreparatomtaleavsnitt) const {
    return {
...
Pakningskomponent FestDeserializer_1::Unpack(const PPakningskomponent &pPakningskomponent) const {
    return {{Unpack(pPakningskomponent.pakningstype), Unpack(pPakningskomponent.mengde)}, pPakningskomponent.antall};
}

PakningskomponentInfo FestDeserializer_1::Unpack(const PPakningskomponentInfo &pPakningskomponentInfo) const {
    return {Unpack(pPakningskomponentInfo.pakningstype), Unpack(pPakningskomponentInfo.mengde)};
}

Pakningsinfo FestDeserializer_1::Unpack(const PPakningsinfo &pakningsinfo) const {
...
PrisVare FestDeserializer_1::Unpack(const PPrisVare &prisVare) const {
    return {Unpack(prisVare.type), Unpack(prisVare.pris), Unpack(prisVare.gyldigFraDato), Unpack(prisVare.gyldigTilDato)};
}

Markedsforingsinfo FestDeserializer_1::Unpack(const PMarkedsforingsinfo &pmarkedsforingsinfo) const {
    return {
...
Refusjon FestDeserializer_1::Unpack(const PRefusjon &pRefusjon) const {
...
PakningByttegruppe FestDeserializer_1::Unpack(const PPakningByttegruppe &pPakningByttegruppe) const {
    return {
...
ProduktInfoVare FestDeserializer_1::Unpack(const PProduktInfoVare &pProduktInfoVare) const {
    return {
...
Leverandor FestDeserializer_1::Unpack(const PLeverandor &pLeverandor) const {
    return {
...
Element FestDeserializer_1::Unpack(const PElement_0_0_0 &pElement) const {
    return {
        Unpack(pElement.id),
...
Element FestDeserializer_1::Unpack(const PElement_0_3_0 &pElement) const {
...
Element FestDeserializer_1::Unpack(const PElement &pElement) const {
...
Term FestDeserializer_1::Unpack(const PTerm &pTerm) const {
   return {
       Unpack(pTerm.term),
...
RefRefusjonsvilkar FestDeserializer_1::Unpack(const PRefRefusjonsvilkar_0_0_0 &pref) const {
    return {
...
RefRefusjonsvilkar FestDeserializer_1::Unpack(const PRefRefusjonsvilkar_1_2_0 &pref) const {
    return {
            Unpack(pref.id).ToString(),
            Unpack(pref.fraDato),
            Unpack(pref.tilDato)
...
RefRefusjonsvilkar FestDeserializer_1::Unpack(const PRefRefusjonsvilkar &pref) const {
...
Refusjonskode FestDeserializer_1::Unpack(const PRefusjonskode_0_0_0 &pref) const {
...
Refusjonskode FestDeserializer_1::Unpack(const PRefusjonskode_0_1_0 &pref) const {
    std::vector<std::string> underterm{};
    {
        auto list = Unpack(stringList, numStringList, pref.underterm);
        for (const auto &put : list) {
...
Refusjonskode FestDeserializer_1::Unpack(const PRefusjonskode_1_2_0 &pref) const {
    std::vector<std::string> underterm{};
    {
        auto list = Unpack(stringList, numStringList, pref.underterm);
        for (const auto &put : list) {
...
Refusjonskode FestDeserializer_1::Unpack(const PRefusjonskode &pref) const {
...
Refusjonsgruppe FestDeserializer_1::Unpack(const PRefusjonsgruppe &pRefusjonsgruppe) const {
...
StrukturertVilkar FestDeserializer_1::Unpack(const PStrukturertVilkar &pStrukturertVilkar) const {
    return {
...
Referanseelement FestDeserializer_1::Unpack(const PReferanseelement_0_0_0 &pReferanseelement) const {
...
Referanseelement FestDeserializer_1::Unpack(const PReferanseelement_0_4_0 &pReferanseelement) const {
    std::vector<std::string> refs{};
    {
...
Referanseelement FestDeserializer_1::Unpack(const PReferanseelement &pReferanseelement) const {
...
Referanse FestDeserializer_1::Unpack(const PReferanse &pReferanse) const {
    return {
...
Substansgruppe FestDeserializer_1::Unpack(const PSubstansgruppe &pSubstansgruppe) const {
...
Substans FestDeserializer_1::Unpack(const PSubstans &pSubstans) const {
    return {
...
DoseFastTidspunkt FestDeserializer_1::Unpack(const PDoseFastTidspunkt &pDoseFastTidspunkt) const {
    return {
...
Dosering FestDeserializer_1::Unpack(const PDosering &pDosering) const {
...
Legemiddelforbruk FestDeserializer_1::Unpack(const PLegemiddelforbruk &pLegemiddelforbruk) const {
...
Lenke FestDeserializer_1::Unpack(const PLenke &lenke) const {
    return {Unpack(lenke.beskrivelse), Unpack(lenke.www)};
}

std::vector<PPakningsinfo> FestDeserializer_1::GetPakningsinfoList(const PLegemiddelpakning_0_0_0 &ppakning) const {
    return Unpack(pakningsinfoList, numPakningsinfo, ppakning.pakningsinfo);
}

std::vector<PPakningsinfo> FestDeserializer_1::GetPakningsinfoList(const PLegemiddelpakning_0_4_0 &ppakning) const {
    return Unpack(pakningsinfoList, numPakningsinfo, ppakning.pakningsinfo);
}

std::vector<PPakningsinfo> FestDeserializer_1::GetPakningsinfoList(const PLegemiddelpakning_1_3_0 &ppakning) const {
    return Unpack(pakningsinfoList, numPakningsinfo, ppakning.pakningsinfo);
}

std::vector<PPakningsinfo> FestDeserializer_1::GetPakningsinfoList(const PLegemiddelpakning &lp) const {
...
std::vector<PElement_0_3_0> FestDeserializer_1::GetElementList(const POppfKodeverk_0_3_0 &pkodeverk) const {
    return Unpack(elementList_0_3_0, numElement_0_3_0, pkodeverk.elements);;
}

std::vector<PElement> FestDeserializer_1::GetElementList(const POppfKodeverk &kodeverk) const {
    struct {
        const FestDeserializer_1 *deserializer;
        std::vector<PElement> operator () (const POppfKodeverk_0_3_0 &kodeverk) {
            std::vector<PElement> element{};
            auto element_0_3_0 = deserializer->GetElementList(kodeverk);
            element.reserve(element_0_3_0.size());
            for (const auto &e : element_0_3_0) {
                element.emplace_back(e);
            }
        ...
        std::vector<PElement> operator () (const POppfKodeverk_0_0_0 &kodeverk) {
            throw PackException("This version does not use the v0.0.0-struct");
        }
    } visitor{.deserializer = this};
    return std::visit(visitor, kodeverk);
}

std::vector<PReseptgyldighet> FestDeserializer_1::GetReseptgyldighetList(const PLegemiddelMerkevare_0_4_0 &pmerkevare) const {
    return Unpack(reseptgyldighetList, numReseptgyldighet, pmerkevare.reseptgyldighet);;
}

std::vector<PReseptgyldighet> FestDeserializer_1::GetReseptgyldighetList(const PLegemiddelMerkevare_0_0_0 &pmerkevare) const {
    return Unpack(reseptgyldighetList, numReseptgyldighet, pmerkevare.reseptgyldighet);;
}

std::vector<PReseptgyldighet> FestDeserializer_1::GetReseptgyldighetList(const PLegemiddelMerkevare &pmerkevare) const {
...
std::vector<FestUuid> FestDeserializer_1::GetRefMerkevare(const PLegemiddelVirkestoff &pvirkestoff) const {
...
std::vector<PFestId> FestDeserializer_1::GetSortertVirkestoffMedStyrke(const PLegemiddel &pLegemiddel) const {
    struct {
        const FestDeserializer_1 *deserializer;
...
std::vector<PFestId> FestDeserializer_1::GetSortertVirkestoffUtenStyrke(const PLegemiddelMerkevare &pLegemiddelMerkevare) const {
    struct {
        const FestDeserializer_1 *deserializer;
...
std::vector<FestUuid> FestDeserializer_1::GetFestUuids(const GenericListItems32 &items) const {
...
std::vector<FestUuid> FestDeserializer_1::GetFestUuids(const GenericListItems64 &items) const {
    std::vector<FestUuid> ids{};
    {
...
std::vector<FestUuid>
FestDeserializer_1::GetFestUuids(const std::variant<GenericListItems32, GenericListItems64> &v) const {
...
std::vector<FestDbQuota> FestDeserializer_1::GetQuotas() const {
