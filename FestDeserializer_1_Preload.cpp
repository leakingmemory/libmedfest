...
void FestDeserializer_1::Preload(FestSerializer &festSerializer) const {
    ...
    FestDeserializerPreloader_1 preloader{};
...
void FestDeserializer_1::Preload(FestSerializer_0 &festSerializer) const {
