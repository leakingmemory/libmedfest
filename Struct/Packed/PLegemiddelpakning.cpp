...
PLegemiddelpakning::PLegemiddelpakning(const PLegemiddelpakning_0_0_0 &p) : PLegemiddelCore(p), std::variant<PLegemiddelpakning_0_0_0,PLegemiddelpakning_0_4_0>(p) {}
PLegemiddelpakning::PLegemiddelpakning(const PLegemiddelpakning_0_4_0 &p) : PLegemiddelCore(p), std::variant<PLegemiddelpakning_0_0_0,PLegemiddelpakning_0_4_0>(p) {}

PValueWithDistinguishedName PLegemiddelpakning::GetPreparattype() const {
    const std::variant<PLegemiddelpakning_0_0_0,PLegemiddelpakning_0_4_0> &p = *this;
...
PRefusjon PLegemiddelpakning::GetRefusjon() const {
    const std::variant<PLegemiddelpakning_0_0_0,PLegemiddelpakning_0_4_0> &p = *this;
    if (std::holds_alternative<PLegemiddelpakning_0_4_0>(p)) {
        return std::get<PLegemiddelpakning_0_4_0>(p).GetRefusjon();
    } else {
        return std::get<PLegemiddelpakning_0_0_0>(p).GetRefusjon();
    }
}
