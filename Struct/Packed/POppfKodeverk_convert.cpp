...
POppfKodeverk_0_3_0::POppfKodeverk_0_3_0(const POppfKodeverk_0_0_0 &src, const FestDeserializer_0 &deserializer, ElementList_0_3_0 &elementList, TermList &termList, std::string &strblock, std::map<std::string,uint32_t> &cache) :
...
POppfKodeverk_0_3_0::POppfKodeverk_0_3_0(const POppfKodeverk_0_0_0 &src, const FestDeserializer_1 &deserializer, ElementList_0_3_0 &elementList, TermList &termList, std::string &strblock, std::map<std::string,uint32_t> &cache) :
        POppf(static_cast<const POppf &>(src)),
        PInfo(static_cast<const PInfo &>(src)),
        elements()
{
    std::vector<PElement_0_3_0> encodedElements{};
    {
        POppfKodeverk poppf{src};
        auto kodeverk = deserializer.Unpack(poppf);
        auto decodedElements = kodeverk.GetElement();
        for (const auto &element: decodedElements) {
            encodedElements.emplace_back(element, termList, strblock, cache);
        }
