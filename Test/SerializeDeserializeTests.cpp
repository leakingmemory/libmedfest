...
int main() {
...

    {
        ...
        {
            AssertVersion(festDeserializer, 0, 3, 0);
    ...
    {
        AssertVersion(festDeserializerDb1, 0, 3, 0);
...

    {
...

        {
            ...
            {
                AssertVersion(festDeserializerDb2, 0, 3, 0);
        ...
        }
        {
            ...
            std::string fest3Db_0_2_0_to_0_3 = WriteFest(
                    [&festDeserializerDb2_0_2_0](FestSerializer &serializer) {
                        festDeserializerDb2_0_2_0.Preload(serializer);
                    });
            std::cout << "DB 3 upgraded from v0.2.0 to v0.3.0 size " << fest3Db_0_2_0_to_0_3.size() << "\n";
            std::string fest3Db_0_1_0_to_0_3 = WriteFest(
                    [&festDeserializerDb2_0_1_0](FestSerializer &serializer) {
                        festDeserializerDb2_0_1_0.Preload(serializer);
                    });
            std::cout << "DB 3 upgraded from v0.1.0 to v0.3.0 size " << fest3Db_0_1_0_to_0_3.size() << "\n";
            std::string fest3Db_0_0_0_to_0_3 = WriteFest(
                    [&festDeserializerDb2_0_0_0](FestSerializer &serializer) {
                        festDeserializerDb2_0_0_0.Preload(serializer);
                    });
            std::cout << "DB 3 upgraded from v0.0.0 to v0.3.0 size " << fest3Db_0_0_0_to_0_3.size() << "\n";
            {
                FestDeserializer festDeserializerDb3_0_2_0_to_0_3{fest3Db_0_2_0_to_0_3.data(),
                                                                     fest3Db_0_2_0_to_0_3.size()};
                {
                    AssertVersion(festDeserializerDb3_0_2_0_to_0_3, 0, 3, 0);
                    auto festVectors = GetFestVectors(festDeserializerDb3_0_2_0_to_0_3);
                    AssertSize(festVectors, 2);
                    auto fest1 = festVectors[0];
                    auto fest2 = festVectors[1];
                    AssertEquals(fest1.GetDato(), festVersion1);
                    AssertEquals(fest2.GetDato(), festVersion2);
                    auto merkevarer1 = fest1.GetLegemiddelMerkevare(festDeserializerDb3_0_2_0_to_0_3);
                    auto merkevarer2 = fest2.GetLegemiddelMerkevare(festDeserializerDb3_0_2_0_to_0_3);
                    AssertSize(merkevarer1, 1);
                    AssertSize(merkevarer2, 1);
                    auto pmerkevare1 = merkevarer1[0];
                    auto merkevare1 = festDeserializerDb3_0_2_0_to_0_3.Unpack(pmerkevare1);
                    AssertEquals(merkevare1.GetLegemiddelMerkevare().GetNavnFormStyrke(),
                                 "Kodimagnyl Ikke-stoppende dak tab 9,6 mg/500 mg/150 mg");
                    auto pmerkevare2 = merkevarer2[0];
                    auto merkevare2 = festDeserializerDb3_0_2_0_to_0_3.Unpack(pmerkevare2);
                    AssertEquals(merkevare2.GetLegemiddelMerkevare().GetNavnFormStyrke(), "Tiberal tab 500 mg");
                    auto pakninger1 = fest1.GetLegemiddelPakning(festDeserializerDb3_0_2_0_to_0_3);
                    auto pakninger2 = fest2.GetLegemiddelPakning(festDeserializerDb3_0_2_0_to_0_3);
                    AssertSize(pakninger1, 1);
                    AssertSize(pakninger2, 1);
                    auto ppakning1 = pakninger1[0];
                    auto pakning1 = festDeserializerDb3_0_2_0_to_0_3.Unpack(ppakning1);
                    AssertEquals(pakning1.GetLegemiddelpakning().GetNavnFormStyrke(), "Kodimagnyl Ikke-stoppende dak tab 9,6 mg/500 mg/150 mg");
                    auto ppakning2 = pakninger2[0];
                    auto pakning2 = festDeserializerDb3_0_2_0_to_0_3.Unpack(ppakning2);
                    AssertEquals(pakning2.GetLegemiddelpakning().GetNavnFormStyrke(), "Tiberal tab 500 mg");
                    auto kodeverk1 = fest1.GetKodeverk(festDeserializerDb3_0_2_0_to_0_3);
                    auto kodeverk2 = fest2.GetKodeverk(festDeserializerDb3_0_2_0_to_0_3);
                    AssertSize(kodeverk1, 1);
                    AssertSize(kodeverk2, 1);
                    auto atc1 = festDeserializerDb3_0_2_0_to_0_3.Unpack(kodeverk1[0]);
                    auto atc2 = festDeserializerDb3_0_2_0_to_0_3.Unpack(kodeverk2[0]);
                    AssertEquals(atc1.GetInfo().GetKortnavn(), "ATC");
                    AssertEquals(atc2.GetInfo().GetKortnavn(), "ATC");
                    auto atc1element = atc1.GetElement();
                    auto atc2element = atc2.GetElement();
            ...
            {
                FestDeserializer festDeserializerDb3_0_1_0_to_0_3{fest3Db_0_1_0_to_0_3.data(),
                                                                  fest3Db_0_1_0_to_0_3.size()};
                {
                    AssertVersion(festDeserializerDb3_0_1_0_to_0_3, 0, 3, 0);
                    auto festVectors = GetFestVectors(festDeserializerDb3_0_1_0_to_0_3);
                    AssertSize(festVectors, 2);
                    auto fest1 = festVectors[0];
                    auto fest2 = festVectors[1];
                    AssertEquals(fest1.GetDato(), festVersion1);
                    AssertEquals(fest2.GetDato(), festVersion2);
                    auto merkevarer1 = fest1.GetLegemiddelMerkevare(festDeserializerDb3_0_1_0_to_0_3);
                    auto merkevarer2 = fest2.GetLegemiddelMerkevare(festDeserializerDb3_0_1_0_to_0_3);
                    AssertSize(merkevarer1, 1);
                    AssertSize(merkevarer2, 1);
                    auto pmerkevare1 = merkevarer1[0];
                    auto merkevare1 = festDeserializerDb3_0_1_0_to_0_3.Unpack(pmerkevare1);
                    AssertEquals(merkevare1.GetLegemiddelMerkevare().GetNavnFormStyrke(),
                                 "Kodimagnyl Ikke-stoppende dak tab 9,6 mg/500 mg/150 mg");
                    auto pmerkevare2 = merkevarer2[0];
                    auto merkevare2 = festDeserializerDb3_0_1_0_to_0_3.Unpack(pmerkevare2);
                    AssertEquals(merkevare2.GetLegemiddelMerkevare().GetNavnFormStyrke(), "Tiberal tab 500 mg");
                    auto pakninger1 = fest1.GetLegemiddelPakning(festDeserializerDb3_0_1_0_to_0_3);
                    auto pakninger2 = fest2.GetLegemiddelPakning(festDeserializerDb3_0_1_0_to_0_3);
                    AssertSize(pakninger1, 1);
                    AssertSize(pakninger2, 1);
                    auto ppakning1 = pakninger1[0];
                    auto pakning1 = festDeserializerDb3_0_1_0_to_0_3.Unpack(ppakning1);
                    AssertEquals(pakning1.GetLegemiddelpakning().GetNavnFormStyrke(), "Kodimagnyl Ikke-stoppende dak tab 9,6 mg/500 mg/150 mg");
                    auto ppakning2 = pakninger2[0];
                    auto pakning2 = festDeserializerDb3_0_1_0_to_0_3.Unpack(ppakning2);
                    AssertEquals(pakning2.GetLegemiddelpakning().GetNavnFormStyrke(), "Tiberal tab 500 mg");
                    auto kodeverk1 = fest1.GetKodeverk(festDeserializerDb3_0_1_0_to_0_3);
                    auto kodeverk2 = fest2.GetKodeverk(festDeserializerDb3_0_1_0_to_0_3);
                    AssertSize(kodeverk1, 1);
                    AssertSize(kodeverk2, 1);
                    auto atc1 = festDeserializerDb3_0_1_0_to_0_3.Unpack(kodeverk1[0]);
                    auto atc2 = festDeserializerDb3_0_1_0_to_0_3.Unpack(kodeverk2[0]);
                    AssertEquals(atc1.GetInfo().GetKortnavn(), "ATC");
                    AssertEquals(atc2.GetInfo().GetKortnavn(), "ATC");
                    auto atc1element = atc1.GetElement();
                    auto atc2element = atc2.GetElement();
            ...
            {
                FestDeserializer festDeserializerDb3_0_0_0_to_0_3{fest3Db_0_0_0_to_0_3.data(),
                                                                  fest3Db_0_0_0_to_0_3.size()};
                {
                    AssertVersion(festDeserializerDb3_0_0_0_to_0_3, 0, 3, 0);
                    auto festVectors = GetFestVectors(festDeserializerDb3_0_0_0_to_0_3);
                    AssertSize(festVectors, 2);
                    auto fest1 = festVectors[0];
                    auto fest2 = festVectors[1];
                    AssertEquals(fest1.GetDato(), festVersion1);
                    AssertEquals(fest2.GetDato(), festVersion2);
                    auto merkevarer1 = fest1.GetLegemiddelMerkevare(festDeserializerDb3_0_0_0_to_0_3);
                    auto merkevarer2 = fest2.GetLegemiddelMerkevare(festDeserializerDb3_0_0_0_to_0_3);
                    AssertSize(merkevarer1, 1);
                    AssertSize(merkevarer2, 1);
                    auto pmerkevare1 = merkevarer1[0];
                    auto merkevare1 = festDeserializerDb3_0_0_0_to_0_3.Unpack(pmerkevare1);
                    AssertEquals(merkevare1.GetLegemiddelMerkevare().GetNavnFormStyrke(),
                                 "Kodimagnyl Ikke-stoppende dak tab 9,6 mg/500 mg/150 mg");
                    auto pmerkevare2 = merkevarer2[0];
                    auto merkevare2 = festDeserializerDb3_0_0_0_to_0_3.Unpack(pmerkevare2);
                    AssertEquals(merkevare2.GetLegemiddelMerkevare().GetNavnFormStyrke(), "Tiberal tab 500 mg");
                    auto pakninger1 = fest1.GetLegemiddelPakning(festDeserializerDb3_0_0_0_to_0_3);
                    auto pakninger2 = fest2.GetLegemiddelPakning(festDeserializerDb3_0_0_0_to_0_3);
                    AssertSize(pakninger1, 1);
                    AssertSize(pakninger2, 1);
                    auto ppakning1 = pakninger1[0];
                    auto pakning1 = festDeserializerDb3_0_0_0_to_0_3.Unpack(ppakning1);
                    AssertEquals(pakning1.GetLegemiddelpakning().GetNavnFormStyrke(), "Kodimagnyl Ikke-stoppende dak tab 9,6 mg/500 mg/150 mg");
                    auto ppakning2 = pakninger2[0];
                    auto pakning2 = festDeserializerDb3_0_0_0_to_0_3.Unpack(ppakning2);
                    AssertEquals(pakning2.GetLegemiddelpakning().GetNavnFormStyrke(), "Tiberal tab 500 mg");
                    auto kodeverk1 = fest1.GetKodeverk(festDeserializerDb3_0_0_0_to_0_3);
                    auto kodeverk2 = fest2.GetKodeverk(festDeserializerDb3_0_0_0_to_0_3);
                    AssertSize(kodeverk1, 1);
                    AssertSize(kodeverk2, 1);
                    auto atc1 = festDeserializerDb3_0_0_0_to_0_3.Unpack(kodeverk1[0]);
                    auto atc2 = festDeserializerDb3_0_0_0_to_0_3.Unpack(kodeverk2[0]);
                    AssertEquals(atc1.GetInfo().GetKortnavn(), "ATC");
                    AssertEquals(atc2.GetInfo().GetKortnavn(), "ATC");
                    auto atc1element = atc1.GetElement();
                    auto atc2element = atc2.GetElement();
    ...
    {
        std::string fest4Db_0_2_0_to_0_3 = WriteFest(
                [&festDeserializerDb1_0_2_0, &festInput2](FestSerializer &serializer) {
                    festDeserializerDb1_0_2_0.Preload(serializer);
                    AssertTrue(serializer.Serialize(festInput2));
                });
        std::cout << "DB 4 upgraded from v0.2.0 to v0.3.0 size " << fest4Db_0_2_0_to_0_3.size() << "\n";
        std::string fest4Db_0_1_0_to_0_3 = WriteFest(
                [&festDeserializerDb1_0_1_0, &festInput2](FestSerializer &serializer) {
                    festDeserializerDb1_0_1_0.Preload(serializer);
                    AssertTrue(serializer.Serialize(festInput2));
                });
        std::cout << "DB 4 upgraded from v0.1.0 to v0.3.0 size " << fest4Db_0_1_0_to_0_3.size() << "\n";
        std::string fest4Db_0_0_0_to_0_3 = WriteFest(
                [&festDeserializerDb1_0_0_0, &festInput2](FestSerializer &serializer) {
                    festDeserializerDb1_0_0_0.Preload(serializer);
                    AssertTrue(serializer.Serialize(festInput2));
                });
        std::cout << "DB 4 upgraded from v0.0.0 to v0.3.0 size " << fest4Db_0_0_0_to_0_3.size() << "\n";
        {
            FestDeserializer festDeserializerDb4_0_2_0_to_0_3{fest4Db_0_2_0_to_0_3.data(),
                                                                 fest4Db_0_2_0_to_0_3.size()};
            {
                AssertVersion(festDeserializerDb4_0_2_0_to_0_3, 0, 3, 0);
                auto festVectors = GetFestVectors(festDeserializerDb4_0_2_0_to_0_3);
                AssertSize(festVectors, 2);
                auto fest1 = festVectors[0];
                auto fest2 = festVectors[1];
                AssertEquals(fest1.GetDato(), festVersion1);
                AssertEquals(fest2.GetDato(), festVersion2);
                auto merkevarer1 = fest1.GetLegemiddelMerkevare(festDeserializerDb4_0_2_0_to_0_3);
                auto merkevarer2 = fest2.GetLegemiddelMerkevare(festDeserializerDb4_0_2_0_to_0_3);
                AssertSize(merkevarer1, 1);
                AssertSize(merkevarer2, 1);
                auto pmerkevare1 = merkevarer1[0];
                auto merkevare1 = festDeserializerDb4_0_2_0_to_0_3.Unpack(pmerkevare1);
                AssertEquals(merkevare1.GetLegemiddelMerkevare().GetNavnFormStyrke(),
                             "Kodimagnyl Ikke-stoppende dak tab 9,6 mg/500 mg/150 mg");
                auto pmerkevare2 = merkevarer2[0];
                auto merkevare2 = festDeserializerDb4_0_2_0_to_0_3.Unpack(pmerkevare2);
                AssertEquals(merkevare2.GetLegemiddelMerkevare().GetNavnFormStyrke(), "Tiberal tab 500 mg");
                auto pakninger1 = fest1.GetLegemiddelPakning(festDeserializerDb4_0_2_0_to_0_3);
                auto pakninger2 = fest2.GetLegemiddelPakning(festDeserializerDb4_0_2_0_to_0_3);
                AssertSize(pakninger1, 1);
                AssertSize(pakninger2, 1);
                auto ppakning1 = pakninger1[0];
                auto pakning1 = festDeserializerDb4_0_2_0_to_0_3.Unpack(ppakning1);
                AssertEquals(pakning1.GetLegemiddelpakning().GetNavnFormStyrke(), "Kodimagnyl Ikke-stoppende dak tab 9,6 mg/500 mg/150 mg");
                auto ppakning2 = pakninger2[0];
                auto pakning2 = festDeserializerDb4_0_2_0_to_0_3.Unpack(ppakning2);
                AssertEquals(pakning2.GetLegemiddelpakning().GetNavnFormStyrke(), "Tiberal tab 500 mg");
                auto kodeverk1 = fest1.GetKodeverk(festDeserializerDb4_0_2_0_to_0_3);
                auto kodeverk2 = fest2.GetKodeverk(festDeserializerDb4_0_2_0_to_0_3);
                AssertSize(kodeverk1, 1);
                AssertSize(kodeverk2, 1);
                auto atc1 = festDeserializerDb4_0_2_0_to_0_3.Unpack(kodeverk1[0]);
                auto atc2 = festDeserializerDb4_0_2_0_to_0_3.Unpack(kodeverk2[0]);
                AssertEquals(atc1.GetInfo().GetKortnavn(), "ATC");
                AssertEquals(atc2.GetInfo().GetKortnavn(), "ATC");
                auto atc1element = atc1.GetElement();
                auto atc2element = atc2.GetElement();
        ...
        {
            FestDeserializer festDeserializerDb4_0_1_0_to_0_3{fest4Db_0_1_0_to_0_3.data(),
                                                              fest4Db_0_1_0_to_0_3.size()};
            {
                AssertVersion(festDeserializerDb4_0_1_0_to_0_3, 0, 3, 0);
                auto festVectors = GetFestVectors(festDeserializerDb4_0_1_0_to_0_3);
                AssertSize(festVectors, 2);
                auto fest1 = festVectors[0];
                auto fest2 = festVectors[1];
                AssertEquals(fest1.GetDato(), festVersion1);
                AssertEquals(fest2.GetDato(), festVersion2);
                auto merkevarer1 = fest1.GetLegemiddelMerkevare(festDeserializerDb4_0_1_0_to_0_3);
                auto merkevarer2 = fest2.GetLegemiddelMerkevare(festDeserializerDb4_0_1_0_to_0_3);
                AssertSize(merkevarer1, 1);
                AssertSize(merkevarer2, 1);
                auto pmerkevare1 = merkevarer1[0];
                auto merkevare1 = festDeserializerDb4_0_1_0_to_0_3.Unpack(pmerkevare1);
                AssertEquals(merkevare1.GetLegemiddelMerkevare().GetNavnFormStyrke(),
                             "Kodimagnyl Ikke-stoppende dak tab 9,6 mg/500 mg/150 mg");
                auto pmerkevare2 = merkevarer2[0];
                auto merkevare2 = festDeserializerDb4_0_1_0_to_0_3.Unpack(pmerkevare2);
                AssertEquals(merkevare2.GetLegemiddelMerkevare().GetNavnFormStyrke(), "Tiberal tab 500 mg");
                auto pakninger1 = fest1.GetLegemiddelPakning(festDeserializerDb4_0_1_0_to_0_3);
                auto pakninger2 = fest2.GetLegemiddelPakning(festDeserializerDb4_0_1_0_to_0_3);
                AssertSize(pakninger1, 1);
                AssertSize(pakninger2, 1);
                auto ppakning1 = pakninger1[0];
                auto pakning1 = festDeserializerDb4_0_1_0_to_0_3.Unpack(ppakning1);
                AssertEquals(pakning1.GetLegemiddelpakning().GetNavnFormStyrke(), "Kodimagnyl Ikke-stoppende dak tab 9,6 mg/500 mg/150 mg");
                auto ppakning2 = pakninger2[0];
                auto pakning2 = festDeserializerDb4_0_1_0_to_0_3.Unpack(ppakning2);
                AssertEquals(pakning2.GetLegemiddelpakning().GetNavnFormStyrke(), "Tiberal tab 500 mg");
                auto kodeverk1 = fest1.GetKodeverk(festDeserializerDb4_0_1_0_to_0_3);
                auto kodeverk2 = fest2.GetKodeverk(festDeserializerDb4_0_1_0_to_0_3);
                AssertSize(kodeverk1, 1);
                AssertSize(kodeverk2, 1);
                auto atc1 = festDeserializerDb4_0_1_0_to_0_3.Unpack(kodeverk1[0]);
                auto atc2 = festDeserializerDb4_0_1_0_to_0_3.Unpack(kodeverk2[0]);
                AssertEquals(atc1.GetInfo().GetKortnavn(), "ATC");
                AssertEquals(atc2.GetInfo().GetKortnavn(), "ATC");
                auto atc1element = atc1.GetElement();
                auto atc2element = atc2.GetElement();
        ...
        {
            FestDeserializer festDeserializerDb4_0_0_0_to_0_3{fest4Db_0_0_0_to_0_3.data(),
                                                              fest4Db_0_0_0_to_0_3.size()};
            {
                AssertVersion(festDeserializerDb4_0_0_0_to_0_3, 0, 3, 0);
                auto festVectors = GetFestVectors(festDeserializerDb4_0_0_0_to_0_3);
                AssertSize(festVectors, 2);
                auto fest1 = festVectors[0];
                auto fest2 = festVectors[1];
                AssertEquals(fest1.GetDato(), festVersion1);
                AssertEquals(fest2.GetDato(), festVersion2);
                auto merkevarer1 = fest1.GetLegemiddelMerkevare(festDeserializerDb4_0_0_0_to_0_3);
                auto merkevarer2 = fest2.GetLegemiddelMerkevare(festDeserializerDb4_0_0_0_to_0_3);
                AssertSize(merkevarer1, 1);
                AssertSize(merkevarer2, 1);
                auto pmerkevare1 = merkevarer1[0];
                auto merkevare1 = festDeserializerDb4_0_0_0_to_0_3.Unpack(pmerkevare1);
                AssertEquals(merkevare1.GetLegemiddelMerkevare().GetNavnFormStyrke(),
                             "Kodimagnyl Ikke-stoppende dak tab 9,6 mg/500 mg/150 mg");
                auto pmerkevare2 = merkevarer2[0];
                auto merkevare2 = festDeserializerDb4_0_0_0_to_0_3.Unpack(pmerkevare2);
                AssertEquals(merkevare2.GetLegemiddelMerkevare().GetNavnFormStyrke(), "Tiberal tab 500 mg");
                auto pakninger1 = fest1.GetLegemiddelPakning(festDeserializerDb4_0_0_0_to_0_3);
                auto pakninger2 = fest2.GetLegemiddelPakning(festDeserializerDb4_0_0_0_to_0_3);
                AssertSize(pakninger1, 1);
                AssertSize(pakninger2, 1);
                auto ppakning1 = pakninger1[0];
                auto pakning1 = festDeserializerDb4_0_0_0_to_0_3.Unpack(ppakning1);
                AssertEquals(pakning1.GetLegemiddelpakning().GetNavnFormStyrke(), "Kodimagnyl Ikke-stoppende dak tab 9,6 mg/500 mg/150 mg");
                auto ppakning2 = pakninger2[0];
                auto pakning2 = festDeserializerDb4_0_0_0_to_0_3.Unpack(ppakning2);
                AssertEquals(pakning2.GetLegemiddelpakning().GetNavnFormStyrke(), "Tiberal tab 500 mg");
                auto kodeverk1 = fest1.GetKodeverk(festDeserializerDb4_0_0_0_to_0_3);
                auto kodeverk2 = fest2.GetKodeverk(festDeserializerDb4_0_0_0_to_0_3);
                AssertSize(kodeverk1, 1);
                AssertSize(kodeverk2, 1);
                auto atc1 = festDeserializerDb4_0_0_0_to_0_3.Unpack(kodeverk1[0]);
                auto atc2 = festDeserializerDb4_0_0_0_to_0_3.Unpack(kodeverk2[0]);
                AssertEquals(atc1.GetInfo().GetKortnavn(), "ATC");
                AssertEquals(atc2.GetInfo().GetKortnavn(), "ATC");
                auto atc1element = atc1.GetElement();
                auto atc2element = atc2.GetElement();
        ...
        std::cout << "DB 4 upgraded from v0.0.0 size " << fest4Db_0_0_0_to_latest.size() << "\n";
        {
            ...
            {
                AssertVersion(festDeserializerDb4_0_3_0_to_latest, 1, 0, 0);
        ...
        }
        {
            ...
            {
                AssertVersion(festDeserializerDb4_0_2_0_to_latest, 1, 0, 0);
        ...
        }
        {
            ...
            {
                AssertVersion(festDeserializerDb4_0_1_0_to_latest, 1, 0, 0);
        ...
        }
        {
            ...
            {
                AssertVersion(festDeserializerDb4_0_0_0_to_latest, 1, 0, 0);
