...
private:
    std::string dato;
    std::vector<uint32_t> legemiddelMerkevare_0_0_0{};
    std::vector<uint32_t> legemiddelMerkevare_0_4_0{};
    std::vector<uint32_t> legemiddelpakning_0_0_0{};
    std::vector<uint32_t> legemiddelpakning_0_4_0{};
    std::vector<uint32_t> legemiddelpakning_1_3_0{};
    std::vector<uint32_t> legemiddelVirkestoff_0_0_0{};
    std::vector<uint32_t> legemiddelVirkestoff_0_4_0{};
    std::vector<uint16_t> medForbrMatr{};
    std::vector<uint16_t> naringsmiddel{};
    std::vector<uint16_t> brystprotese{};
    std::vector<uint32_t> legemiddeldose_0_0_0{};
    std::vector<uint32_t> legemiddeldose_0_4_0{};
